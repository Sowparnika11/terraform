...
resource "aws_memorydb_cluster" "sample-cluster" {
...
resource "aws_memorydb_user" "db_user" {
...
resource "aws_memorydb_acl" "db_acl" {
...
resource "aws_memorydb_parameter_group" "db_param_group" {
